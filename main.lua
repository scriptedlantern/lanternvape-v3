...
local function LayoutCategories()
    ...
    for i,n in ipairs(Categories) do
        ...
        if not Moved[n] then
            ...
            Panels[n].Size = UDim2.fromOffset(
                cw,
                ch
            )
...
local BlatantModules =
    Panels.Blatant:FindFirstChild("Modules")
...
local function SetSpeedEnabled(v)
    ...
    SpeedRow.BackgroundColor3 =
        v and Config.OrangeDark
        or Config.Darker
...
local function ClearUtility()
    ...
    for _,c in ipairs(UtilityBody:GetChildren()) do
        ...
        if c ~= BodyList
            and not c:IsA("UIPadding")
            and not c:IsA("UIGridLayout") then
...
local function BuildSettingsSidebar()
    ...
    MakeMenuButton(
        ...
        function()
            ...
            UtilitySubtitle.Text =
                "LanternVape v"..Config.Version
            ...
            UtilityRow(
                "Community",
                "Thank you for using LanternVape!"
            )

            UtilityRow(
                "Discord",
                "discord.gg/Pa7aGyKjPR"
            )
...
local function ApplyTheme(c)
    ...
    for _,o in ipairs(Gui:GetDescendants()) do
        ...
        if o:IsA("UIStroke")
            and o.Color ~= Color3.new(0,0,0) then
...
local function BuildNormalSidebar()
    ...
    MenuButtons.Settings.MouseButton1Click:Connect(
        function()
    ...
    MenuButtons.Profiles.MouseButton1Click:Connect(
        function()
    ...
    MenuButtons.Targets.MouseButton1Click:Connect(
        function()

            Utility.Visible = true
            Content.Visible = false

            UtilityTitle.Text = "Targets"
            UtilitySubtitle.Text =
    ...
    MenuButtons.Themes.MouseButton1Click:Connect(
        function()
    ...
    MenuButtons.Keybinds.MouseButton1Click:Connect(
        function()

            Utility.Visible = true
            Content.Visible = false

            UtilityTitle.Text = "Keybinds"
            UtilitySubtitle.Text =
                "Keyboard shortcuts"
    ...
    MenuButtons.About.MouseButton1Click:Connect(
        function()

            Utility.Visible = true
            Content.Visible = false

            UtilityTitle.Text = "About"
            UtilitySubtitle.Text =
                "LanternVape v"..Config.Version
...
UtilityBack.MouseButton1Click:Connect(
    function()

        ReturnToNormalSidebar()
...
local function toggleMain()
    ...
    if Main.Visible then
        ...
        if SettingsState.BlurBackground
            and not SettingsState.HideGUI then
...
Mobile.MouseButton1Click:Connect(
    toggleMain
)
...
UIS.InputBegan:Connect(
    function(i,p)
        ...
        if not p
            and (
                i.KeyCode == Enum.KeyCode.LeftShift
                or i.KeyCode == Enum.KeyCode.RightShift
            ) then
...
local function Layout()
    ...
    if UIS.TouchEnabled
        and SettingsState.CompactMobile then
...
local function FinishLoading()
    ...
    Main.Visible =
        not SettingsState.HideGUI

    Mobile.Visible =
        UIS.TouchEnabled

    if Main.Visible
        and SettingsState.BlurBackground then
